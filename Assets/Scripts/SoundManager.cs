...
public class SoundManager : MonoBehaviour
{
    ...
    {
        DeliveryCounter deiveryCounter = DeliveryCounter.Instance;
        PlaySound(audioClipRefsSO.deliverySuccess, deiveryCounter.transform.position);
    }
    
    private void DeliveryManagerOnRecipeFailed(object sender, EventArgs e)
    {
        DeliveryCounter deiveryCounter = DeliveryCounter.Instance;
        PlaySound(audioClipRefsSO.deliveryFail, deiveryCounter.transform.position);
    }
